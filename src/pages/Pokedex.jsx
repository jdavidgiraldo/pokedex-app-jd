  ...
  return (
    <section className='min-h-screen'>
      ...
      <section className='flex flex-wrap gap-5 py-6 gap-x-6  justify-center pb-16'>
        <div className='min-w-[100%] grid p-6 justify-center sm:-translate-x-20 lg:-translate-x-56 xl:-translate-x-[24rem]'>
          <p><span className='text-primary font-bold'>Wellcome {nameTrainer}, </span> here you can find your favorite pokemon </p>
        </div>
      ...
      <ul className='flex gap-3 justify-center py-10 px-2 flex-wrap '>
        {/*pagina anterior */}
        <li onClick={() => setCurrentPage(1)} className='p-3 bg-red-600 text-white rounded-md cursor-pointer'>{'<<'}</li>
        ...
        {/*ultima pagina */}
        <li onClick={() => setCurrentPage(lastPage)} className='p-3 bg-red-600 text-white rounded-md cursor-pointer'>{'>>'}</li>
      </ul>
